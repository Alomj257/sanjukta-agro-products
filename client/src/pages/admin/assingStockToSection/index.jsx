...
const AssignStockToSection = () => {
  ...
  return (
    <div className=''>
         ...
         <DistributeStock error={error} setError={setError} stocks={stocks} setStocks={setStocks} />
         <div className="col-md-4 section_item mt-5 mx-auto" onClick={handleSubmit}  >
            <Button>
